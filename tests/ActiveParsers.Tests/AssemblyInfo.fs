...
[<assembly: AssemblyTitleAttribute("ActiveParsers.Tests")>]
[<assembly: AssemblyProductAttribute("ActiveParsers")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "ActiveParsers.Tests"
    let [<Literal>] AssemblyProduct = "ActiveParsers"
